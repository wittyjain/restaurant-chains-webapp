...
function NavBar() {
  ...
  return (
    <div className="text-white bg-black md:h-28 md:flex gap-5 justify-between uppercase  px-3 py-2 items-center md:opacity-80 sticky z-[20] top-0 hidden ">
      ...
      <ul className="md:flex md:gap-x-4 items-center md:text-xs font-semibold  tracking-widest  flex-row text-sm">
        {navList.map((item) => (
          <li
            ...
            key={item.text}
          >
            <NavLink to={item.page}>{item.text}</NavLink>
          </li>
        ))}

        <ul className="flex md:gap-3 justify-center md:pb-0 md:border-none border-b-2 pb-8">
          <li>
            <img src={fblogo} alt="" className="md:max-w-6 w-12 " />
          </li>
          <li>
            <img src={instalogo} alt="" className="md:w-6 w-12" />
          </li>
        </ul>
      ...
      <div className="md:flex hidden">
        <button
          className="flex items-center  border-solid border-2 px-4 py-2  mr-2 capitalize
        ...
        <button
          className=" flex items-center border-solid border-2 px-4 py-1 mr-2 capitalize
         text-xs tracking-wider"
        >
          <FiChevronRight />
          japanese
        ...
        <button
          className="flex items-center border-solid border-2 px-4 py-1 capitalize
         text-xs tracking-wider"
        >
          <FiChevronRight />
          online shop
